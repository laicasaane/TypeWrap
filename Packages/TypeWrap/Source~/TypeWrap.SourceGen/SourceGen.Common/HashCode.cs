...
namespace SourceGen.Common
{
    ...
    internal struct HashCode
    {
        ...
        private const uint PRIME_1 = 2654435761U;
        private const uint PRIME_2 = 2246822519U;
        private const uint PRIME_3 = 3266489917U;
        private const uint PRIME_4 = 668265263U;
        private const uint PRIME_5 = 374761393U;
        ...
        {
            return RotateLeft(hash + input * PRIME_2, 13) * PRIME_1;
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static uint QueueRound(uint hash, uint queuedValue)
        {
            return RotateLeft(hash + queuedValue * PRIME_3, 17) * PRIME_4;
        }
